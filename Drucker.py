...
GPIO.add_event_detect(21, GPIO.FALLING, callback = dataWrite, bouncetime = 1000)						#Auf fallende Flanke reagieren
GPIO.add_event_detect(21, GPIO.RISING, callback = drucken, bouncetime = 1000)							#Auf steigende Flanke reagieren
